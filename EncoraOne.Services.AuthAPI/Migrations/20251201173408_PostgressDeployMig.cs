...
namespace Grievance.API.Migrations
{
    /// <inheritdoc />
    public partial class PostgressDeployMig : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedAt", "Email", "FullName", "IsActive", "PasswordHash", "ResetToken", "ResetTokenExpires", "Role" },
                values: new object[] { 1, new DateTime(2025, 12, 1, 17, 34, 8, 132, DateTimeKind.Utc).AddTicks(2330), "admin@encora.com", "Super Admin", true, "Admin@123", null, null, 1 });

            migrationBuilder.InsertData(
                table: "Managers",
                columns: new[] { "Id", "DepartmentId", "JobTitle" },
                values: new object[] { 1, 1, "Chief Administrator" });
